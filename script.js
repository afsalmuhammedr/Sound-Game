class EnhancedAudioSurvivalGame {
  ...
  setupEventListeners() {
    ...
    this.swipeArea.addEventListener("mouseleave", () => this.cancelHoldTimer());
    ...
    this.swipeArea.addEventListener("touchmove", (e) => e.preventDefault(), {
      passive: false,
    });
  }
  ...
  handleTouchEnd(e) {
    ...
    this.processSwipe(this.touchStartX, this.touchStartY, touchEndX, touchEndY);
  }
